        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredGenresJson = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecommendationProfiles_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shows_Institutions_InstitutionId",
                        column: x => x.InstitutionId,
                        principalTable: "Institutions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItems_Performances_PerformanceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_PerformanceId",
                table: "OrderItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Performances_ShowId_StartTime",
                table: "Performances",
                columns: new[] { "ShowId", "StartTime" });

            migrationBuilder.CreateIndex(
                name: "IX_RecommendationProfiles_UserId",
