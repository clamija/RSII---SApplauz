...
class SuperAdminAdminScreen extends StatefulWidget {
  final User user;

  const SuperAdminAdminScreen({super.key, required this.user});

  @override
  State<SuperAdminAdminScreen> createState() => _SuperAdminAdminScreenState();
}

class _SuperAdminAdminScreenState extends State<SuperAdminAdminScreen> {
  @override
      ...
      child: ListView(
        children: [
          ...
          _buildFeatureCard(
            ...
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const ManagerReportsScreen()),
            ),
          ),
        ],
      ),
